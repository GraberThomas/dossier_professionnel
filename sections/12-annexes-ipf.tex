...
% Les sections R.3 et R.4 commencent par des tableaux [H] suffisamment hauts
% pour provoquer une page vide lorsque LaTeX tente de les placer après la
% section précédente. On force ici leur démarrage sur une nouvelle page,
% sans modifier la structure ni le contenu des fiches de tests.
\begingroup
\let\ipforiginalsection\section
\renewcommand{\section}[1]{%
  \ifnum\value{section}>1\clearpage\fi
