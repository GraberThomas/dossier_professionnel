...
\input{figures/annexes/ipf/personna.tex}
...
\input{figures/annexes/ipf/exigences_fonctionnelles_table.tex}
...
\input{figures/annexes/ipf/exigences_non_fonctionnelles_table.tex}

\input{figures/annexes/ipf/KPI.tex}

\input{figures/annexes/ipf/registre-risque.tex}

% Les tableaux [H] de R.2 et R.3.3 laissent un espacement vertical de fin de
% flottant (\intextsep). Lorsque le tableau termine exactement une page, cet
% espacement peut se retrouver seul sur la page suivante ; le gros bloc
% section + sous-section + tableau est alors reporté encore une page plus loin,
% ce qui produit une page visuellement blanche. On supprime uniquement cet
% espacement résiduel avant R.3 et R.4, sans forcer de saut de page.
\begingroup
\let\ipforiginalsection\section
\renewcommand{\section}[1]{%
  \ifnum\value{section}>1
    \ifdim\lastskip>0pt\vskip-\lastskip\fi
  \fi
  \ipforiginalsection{#1}%
}
\input{figures/annexes/ipf/fiche_de_tests_funcitonneles.tex}
\endgroup
\label{ann:ipf-tests-fonctionnels}

\input{figures/annexes/ipf/entreprient-fin-projet.tex}

\input{figures/annexes/ipf/veille-technologique.tex}
