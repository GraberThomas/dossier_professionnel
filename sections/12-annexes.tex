...
\chapter{Présentation d'avancement du projet S-123}
\label{ann:s123-presentation}

Ce support a été utilisé pour présenter l'état d'avancement du projet S-123 et la proposition de méta-modèle. Il retrace notamment les limites de l'implémentation initiale, la recherche d'une représentation plus générique des catalogues S-100, le prototype de méta-base, l'API d'interrogation et les pistes de travail restant à arbitrer. Il constitue ainsi une trace de la démarche de conception, mais aussi du partage des choix techniques avec les parties prenantes du projet.

\includepdf[
  pages=-,
  pagecommand={\thispagestyle{plain}}
]{figures/annexes/reuinion_S123-ed-2.pdf}
