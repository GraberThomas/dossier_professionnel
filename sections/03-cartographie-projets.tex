...
Les autres projets complètent la couverture du référentiel, notamment sur le développement back-end, le développement front-end, le traitement de données, le \terme{devops} et le pilotage d'équipe.

\section{Projets retenus}

Les projets retenus sont les suivants : \terme{fcu} / Ediacara, \terme{s123}, FeastVerse, Brise-glace, Projet Data / IA, Observability server et IPF 2026 Lynx Immo.
