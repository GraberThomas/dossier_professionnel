...
\newglossaryentry{etl}{
    name=ETL,
    description={Extract, Transform, Load, famille d'outils et de traitements permettant d'extraire des données, de les transformer puis de les charger dans un système cible ; FME est utilisé au SHOM comme ETL spécialisé dans les données géospatiales}
}
